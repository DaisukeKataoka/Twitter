...
class QueriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create query" do
    assert_difference('Query.count') do
      post queries_url, params: { query: { content_query: @query.content_query, context_query: @query.context_query, q_id: @query.q_id } }
    end
  ...
  test "should update query" do
    patch query_url(@query), params: { query: { content_query: @query.content_query, context_query: @query.context_query, q_id: @query.q_id } }
